...
class HomePage(BasePage):
    ...
    def verify_home_page_loaded(self) -> None:
        ...
        assert self.is_element_visible(self.INVENTORY_CONTAINER), "Inventory container is not visible"
        assert self.is_element_visible(self.SHOPPING_CART_LINK), "Shopping cart link is not visible"
