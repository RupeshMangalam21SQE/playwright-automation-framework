...
class BasePage(ABC):
    ...
    def navigate_to(self, url: Optional[str] = None) -> None:
        ...
        self.page.goto(
            target_url, wait_until="networkidle", timeout=Config.NAVIGATION_TIMEOUT
        )
    ...
    def select_dropdown_option(
        self, locator: str, option: str, by: str = "value"
    ) -> None:
    ...
    def verify_page_title(self, expected_title: Optional[str] = None) -> None:
        ...
        assert (
            expected in actual
        ), f"Expected title '{expected}' not found in '{actual}'"
